...
<html>
<head>
    <title><fmt:message key="update_order"></fmt:message></title>
    <link rel="stylesheet" href="css/style.css">
</head>
<body class="body">
<jsp:include page="/WEB-INF/pages/common/header.jsp"></jsp:include>
<br><br>
<div align="center"><h1><fmt:message key="update_order"></fmt:message></h1></div>
    <form>
        <input type="hidden" name="command" value="UpdateOrder">
        <div align="center">
            <table>
                <tr>
                    <td><fmt:message key="order_id"></fmt:message></td>
                    <td><c:out value="${orders.orderId}"></c:out></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td> <p><textarea rows="5" cols="50" name="comment" placeholder="Комментарий"><c:out value="${orders.comment}"></c:out></textarea></p></td>
                </tr>
                <tr>
